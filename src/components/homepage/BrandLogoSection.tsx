// src/components/homepage/BrandLogoSection.tsx
"use client";
...
const BrandLogoCard: React.FC<BrandLogoCardProps> = ({ logo }) => (
  <motion.div
    ...
    className={`
      ...
      hover:shadow-[0_0_25px_${logo.glow}]
      transition-all 
  ...
  return (
    <section className="py-20 bg-linear-to-b from-white to-gray-50 border-y border-gray-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2
            className="text-3xl md:text-4xl font-orbitron font-bold tracking-widest uppercase text-gray-900 drop-shadow-sm"
          >
            Trusted Service for Leading Laptop Brands
          </h2>
