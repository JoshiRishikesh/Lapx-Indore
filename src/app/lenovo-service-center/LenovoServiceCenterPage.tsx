...
import LenovoCarousel from "@/components/LenovoCarousel";
...
const LenovoServiceCenterPage: React.FC = () => {
  const theme = useBrandTheme();

  const lenovoServices = [
    {
  ...
  return (
    <div className="bg-linear-to-b from-gray-50 to-white">
      ...
      {/* PROMO SECTION */}
      <BrandPromo
        imageSrc="/brand/lenovo/homepage.avif"
        brandName="Lenovo"
      />
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-orbitron font-bold uppercase tracking-widest text-gray-900">
              Our Specialized Lenovo Repair Expertise
            </h2>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
            {lenovoServices.map((service) => (
              <div
                key={service.title}
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <h2 className="text-4xl font-orbitron font-bold uppercase tracking-widest text-gray-900 mb-12">
            Why Choose Our Lenovo Service Center?
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <div className="p-8 bg-white border border-gray-200 rounded-2xl shadow-md hover:shadow-xl transition-all">
              ...
              <p className="text-gray-600">High-grade, original Lenovo parts ensuring long-lasting performance.</p>
            </div>
            ...
            <div className="p-8 bg-white border border-gray-200 rounded-2xl shadow-md hover:shadow-xl transition-all">
              ...
              <p className="text-gray-600">Fast replacement for screens, keyboards, batteries &amp; essential parts.</p>
            </div>
            ...
            <div className="p-8 bg-white border border-gray-200 rounded-2xl shadow-md hover:shadow-xl transition-all">
              ...
              <p className="text-gray-600">Specialized experts trained in Lenovo motherboard architecture.</p>
            </div>
...
export default LenovoServiceCenterPage;
