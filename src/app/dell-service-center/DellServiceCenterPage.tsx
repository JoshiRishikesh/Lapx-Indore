...
import DellCarousel from "@/components/DellCarousel";
...
const DellServiceCenterPage: React.FC = () => {
  ...
  const dellServices = [
    {
      ...
      description:
        "Component-level repair for all Dell motherboards, including liquid damage, IC replacement &amp; short-circuit fixes.",
    },
    {
      icon: getThemedIcon(FaGamepad, theme.icon),
      title: "Dell Gaming Laptop Care (Alienware / Inspiron)",
      description:
        "Specialized thermal servicing, performance optimization &amp; deep cleaning for Alienware and Inspiron gaming laptops.",
    },
    {
      icon: getThemedIcon(MdDisplaySettings, theme.icon),
      title: "Screen &amp; Display Replacement",
      description:
        "Premium display replacement for Inspiron, XPS, and Alienware — including touchscreen &amp; high-refresh panels.",
    },
    {
      icon: getThemedIcon(FaBatteryFull, theme.icon),
      title: "Battery &amp; Keyboard Replacement",
      description:
        "Original Dell batteries, keyboards &amp; trackpads for reliable long-term performance.",
    },
    {
    ...
    },
    {
      ...
      description:
        "Boost your Dell laptop performance with professional SSD &amp; RAM upgrades.",
    },
  ];
  ...
  return (
    <div className="bg-linear-to-b from-gray-50 to-white">
      ...
      {/* PROMO SECTION */}
      <BrandPromo
        imageSrc="/brand/dell/homepage.avif"
        brandName="Dell"
      />
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-orbitron font-bold uppercase tracking-widest text-gray-900">
              Our Specialized Dell Repair Expertise
            </h2>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
            {dellServices.map((service) => (
              <div
                key={service.title}
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <h2 className="text-4xl font-orbitron font-bold uppercase tracking-widest text-gray-900 mb-12">
            Why Choose Our Dell Service Center?
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <div className="p-8 bg-white border border-gray-200 rounded-2xl shadow-md hover:shadow-xl transition-all">
              ...
              <p className="text-gray-600">
                High-grade, original Dell parts ensuring long-lasting performance.
              </p>
            </div>
            ...
            <div className="p-8 bg-white border border-gray-200 rounded-2xl shadow-md hover:shadow-xl transition-all">
              ...
              <p className="text-gray-600">
                Specialized experts trained in Dell motherboard architecture.
              </p>
            </div>
...
export default DellServiceCenterPage;
